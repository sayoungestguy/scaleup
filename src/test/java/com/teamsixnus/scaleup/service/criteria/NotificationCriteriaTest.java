...
class NotificationCriteriaTest {
    ...
    private static void setAllFilters(NotificationCriteria notificationCriteria) {
        ...
        notificationCriteria.notificationRefId();
        notificationCriteria.isRead();
        notificationCriteria.createdBy();
        notificationCriteria.createdDate();
        notificationCriteria.lastModifiedBy();
        notificationCriteria.lastModifiedDate();
        notificationCriteria.userProfileId();
        notificationCriteria.typeId();
    ...
    private static Condition<NotificationCriteria> criteriaFiltersAre(Function<Object, Boolean> condition) {
        return new Condition<>(
            criteria ->
                ...
                condition.apply(criteria.getNotificationRefId()) &&
    ...
    private static Condition<NotificationCriteria> copyFiltersAre(
        ...
        return new Condition<>(
            criteria ->
                ...
                condition.apply(criteria.getNotificationRefId(), copy.getNotificationRefId()) &&
