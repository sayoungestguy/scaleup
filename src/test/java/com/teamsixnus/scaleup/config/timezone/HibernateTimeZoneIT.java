package com.teamsixnus.scaleup.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import com.teamsixnus.scaleup.IntegrationTest;
import com.teamsixnus.scaleup.repository.timezone.DateTimeWrapper;
import com.teamsixnus.scaleup.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM tbl_date_time_wrapper where id=%d", fieldName, id);
    }
