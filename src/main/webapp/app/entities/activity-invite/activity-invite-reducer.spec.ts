...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches UPDATE_ACTIVITYINVITE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ACTIVITYINVITE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ACTIVITYINVITE actions', async () => {
      const arg = 42666;
